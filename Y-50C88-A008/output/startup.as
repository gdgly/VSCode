	...
	; Compiler options:
	;
	; -oY-50C88.cof -mY-50C88.map --summary=default,-psect,-class \
	; --fill=0xFFFF --output=intel adc.p1 cook.p1 delay.p1 display.p1 \
	; error.p1 key.p1 main.p1 sound.p1 time.p1 var_global.p1 --chip=89F23X5 \
	; -P --runtime=default, --opt=-debug,-local,-asmfile,+asm,-speed,+space \
	; -E+cmscerr.err -D__DEBUG=1 -g --asmlist --warn=0 \
